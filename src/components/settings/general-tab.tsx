...
export function GeneralTab({ isAdmin = false }: { isAdmin?: boolean }) {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* The global Coverage Mode toggle (2026-07-14) was retired same-day by
          the departments redesign: the coverage ladder is the permanent
          engine default; the weak-student fallback is per student on
          /students/[id]/progress (learning mode card). */}
