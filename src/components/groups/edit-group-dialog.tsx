...
//
// Uses a full-screen Dialog (not a vaul bottom Drawer) for instant open —
// the slide-up animation made the editor feel sluggish on mobile.
    ...
    <DialogPrimitive.Root open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogPrimitive.Portal>
        ...
        >
          ...
          {groupId && <EditGroupBody groupId={groupId} onClose={onClose} />}
        </DialogPrimitive.Popup>
      </DialogPrimitive.Portal>
  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="max-w-lg mx-auto px-4 pb-10 pt-4">
        ...
        {/* Group settings. Native <select> for consistency with the rest of
            the app's small triggers — bypasses any portal/popup overlap with
            the dialog itself. */}
