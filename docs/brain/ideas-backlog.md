...
| 5b | **Native-feel performance program** (founder-requested 2026-06-12). Cold open is slow: blank auth screen (auth-layout returns null while Clerk verifies), network-first service worker, ~6 startup queries × 230–780ms Sri Lanka→US RTT. 5 phases in _audit/findings.md; phases 1–2 (SW cache-first + skeleton shell) SHIPPED 2026-06-12; phases 3–5 (merged home query, optimistic UI, bundle trim) remain. | app shell | Teacher efficiency + brand quality | M | 4 |
