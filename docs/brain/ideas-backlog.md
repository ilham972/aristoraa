...
| 8b | **Paper-class phase 2** — SHIPPED 2026-06-17 as a per-student PLANNER (not the literal Week-grid overlay, which was dropped as too cluttered): "Plan student" picks a student (sorted lightest-load-first) and shows their whole week (personal/paper/busy/free + tappable "can join" blocks); paper-revenue card added to /analytics Finance→Revenue. | scheduling | Teacher efficiency + revenue | M | 3 |
